...
<head>
    ...
    <title>   SIE QDL | Listado del Material entregado</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado del Material entregado</a></li>
            </ul>
...
$sentencia = $connect->prepare("SELECT material.id_mat, material.fecha, material.idpa, material.material, material.motivo,  patients.idpa, patients.numhs, patients.nompa, patients.apepa, patients.grup FROM material INNER JOIN patients ON material.idpa = patients.idpa ORDER BY id_mat DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
         ...
         <table id="example" class="responsive-table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Material Entregado</th>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Médico"><?php echo $d->material ?></td>
                        <td data-title="Médico"><?php echo $d->motivo ?></td>
                        <td>

                            

                <a title="Información" href="../material/info.php?id=<?php echo $d->id_mat ?>" class="fa fa-info"></a>
               
                
                <?php 
                                
                                
                echo '<a title="Boleta"  href="../material/documento.php?id='.$d->id_mat.'" class="fa fa-file-text-o"></a>';
                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){
                //echo '<a title="Ticket"  href="../material/ticket.php?id='.$d->id_mat.'" class="fa fa-ticket"></a>';                  
                }                
...
<?php if (in_array($_SESSION['rol'], [1, 2])): ?>
                ...
                <input type='hidden' name='id_mat' value="<?php echo  $d->id_mat; ?>">
                <button name='delete_material' style="cursor: pointer;" class="fa fa-trash"></button>
                </form>
                        <?php endif; ?>
                        </td>
                    </tr>
    ...
    <?php include_once '../../backend/php/delete_material.php' ?>
