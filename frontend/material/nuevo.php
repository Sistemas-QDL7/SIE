...
<head>
    ...
    <title>   SIE QDL | Nueva entrega de Material</title>
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Registrar entrega de Material</a></li>
            </ul>

            <!-- multistep form -->
            <form action="../../backend/php/add_material.php" enctype="multipart/form-data" method="POST" autocomplete="off">
                <div class="containerss">
                    <h1>Registrar entrega de Material</h1>
                    ...
                    <label for="email"><b>Material Entregado</b></label><span class="badge-warning">*</span>
                    <textarea name="material" style="height:200px" placeholder="Material Entregado..."></textarea>
                    ...
                    <hr>
                    <button type="submit" name="add_material" class="registerbtn">Guardar</button>
                </div>
            </form>
        </main>
        <!-- MAIN -->
    ...
    <?php include_once '../../backend/php/add_material.php' ?>
</body>
</html>