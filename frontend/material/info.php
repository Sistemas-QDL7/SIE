    ...
    <section id="content">
        ...
        <h1 class="title">Bienvenido <?php echo '<strong>'.$_SESSION['name'].'</strong>'; ?></h1>
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../material/mostrar.php">Listado de las entregas de Material</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Información de las entre de material</a></li>
            </ul>
                   <!-- multistep form -->
<?php 
require '../../backend/bd/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT material.id_mat, material.fecha, material.material, material.motivo, material.idpa, patients.idpa, patients.numhs, patients.nompa, patients.apepa, patients.grup FROM material INNER JOIN patients ON material.idpa = patients.idpa WHERE id_mat= '$id';");
 $sentencia->execute();
...
<br>
    ...
    <label for="psw"><b>Material</b></label><span class="badge-warning">*</span>
    <input readonly type="text" value="<?php echo $d->material; ?>" name="appini"required="">
