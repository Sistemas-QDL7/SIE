...
<head>
    ...
    <title>   SIE QDL | Cambiar contraseña del colaborador</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Cambiar contraseña del colaborador</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Cambiar contraseña del colaborador</h1>
