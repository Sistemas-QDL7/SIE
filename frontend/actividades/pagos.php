...
<head>
    ...
    <title>   SIE QDL | Historial de los pagos de colaborador</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../actividades/mostrar.php">Listado de los colaboradores</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Historial de los pagos de colaborador</a></li>
            </ul>
           <br>
