...
<head>
    ...
    <title>   SIE QDL | Listado de Servicios de Atención</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los Servicios de Atención</a></li>
            </ul>
                ...
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <?php 
                                if ($_SESSION['rol'] == 1) {
                                    // code...
                                    echo '<a title="Actualizar" href="../recursos/laboratorios_editar.php?id=<?php echo $d->idlab ?>" class="fa fa-pencil tooltip"></a>';
