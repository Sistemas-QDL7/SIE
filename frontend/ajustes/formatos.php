...
<head>
    ...
    <title>   SIE QDL | Listado de los Formatos</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los Formatos</a></li>
            </ul>
...
$sentencia = $connect->prepare("SELECT * FROM format_templates;");
 $sentencia->execute();
$data =  array();
if($sentencia){
         ...
         <table id="example" class="responsive-table">
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        <td data-title="Cita"><?php echo $d->codigo ?></td>
                        <td data-title="Médico"><?php echo $d->elaboracion?></td>
                        <td data-title="Médico"><?php echo $d->revision ?></td>
                        <td data-title="Médico"><?php echo $d->expiracion ?></td>
                        <td data-title="Laboratorio"><?php echo $d->rev ?></td>
                        <td data-title="Fecha inicio"><?php echo $d->paginas ?></td>
                        <td data-title="Descripción"><?php echo $d->descripcion ?></td>
                        <td data-title="Servicio de Atencion"><?php echo $d->last_updated ?></td>
                        <td>

                            
                <a title="Actualizar" href="../ajustes/editar_formatos.php?id=<?php echo $d->id ?>" class="fa fa-pencil tooltip"></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            </tbody>
