...
<head>
    ...
    <title>   SIE QDL | Actualizar Formatos</title>
</head>
<body>
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                <li><a href="../admin/escritorio.php">Home</a></li>
                 <li class="divider">></li>
                <li><a href="#" class="active">Actualizar Formatos</a></li>
            </ul>
    
    <?php 
require '../../backend/bd/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM format_templates  WHERE id= '$id';");
 $sentencia->execute();
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Actualizar Formatos</h1>

    <hr>
    <br>
    <label for="email"><b>Código</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="<?php echo $d->codigo; ?>" value="<?php echo $d->codigo; ?>" name="codigo" required>

    <label for="email"><b>Elaboración</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="<?php echo $d->elaboracion; ?>" value="<?php echo $d->elaboracion; ?>" name="elaboracion" required>

    <label for="email"><b>Revisión</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="<?php echo $d->revision; ?>" value="<?php echo $d->revision; ?>" name="revision" required>

    <label for="email"><b>Expiración</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="<?php echo $d->expiracion; ?>" value="<?php echo $d->expiracion; ?>" name="expiracion" required>

    <label for="email"><b>Revisión</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="<?php echo $d->rev; ?>" value="<?php echo $d->rev; ?>" name="rev" required>

    <label for="email"><b>Páginas</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="<?php echo $d->paginas; ?>" value="<?php echo $d->paginas; ?>" name="paginas" required>

    <input type="hidden" name="id" value="<?php echo $d->id; ?>">
   

    <hr>
    <button type="submit" name="upd_formatos" class="registerbtn">Guardar</button>
...
<?php endforeach; ?>
 ...
 <?php include_once '../../backend/php/upd_formatos.php' ?>
</body>
</html>
