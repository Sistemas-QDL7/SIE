...
//información de # de factura
    ...
    $this->Text(10,48, utf8_decode('DATOS DEL  COLABORADOR'));
    $this->Ln(50);

    // Agregamos los Genograma del colaborador

    $this->SetFont('Arial','B',10);    
    $this->Text(10,75, utf8_decode('GENOGRAMA DEL  COLABORADOR'));
    $this->Ln(50);


// Agregamos los Consulta del colaborador

    $this->SetFont('Arial','B',10);    
    $this->Text(10,166, utf8_decode('CONSULTA DEL  COLABORADOR'));
    $this->Ln(50);
    ...
    $this->SetFont('Arial','B',10);    
    $this->Text(10,199, utf8_decode('TRATAMIENTO DEL  COLABORADOR'));
    $this->Ln(50);
