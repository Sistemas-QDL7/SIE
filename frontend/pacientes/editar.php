...
<head>
    ...
    <title>   SIE QDL | Actualizar colaborador</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Actualizar colaborador</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  ...
  <br>
    ...
    <label for="email"><b>Número de control</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: ASCS855CS74" value="<?php echo $d->numhs; ?>" name="nhi" maxlength="8" <?php echo (!isset($_SESSION['rol']) || !in_array($_SESSION['rol'], [1, 2])) ? 'readonly' : ''; ?> required>
    ...
    <input type="text" placeholder="ejm: Juan Raul" name="namp" value="<?php echo $d->nompa; ?>" <?php echo (!isset($_SESSION['rol']) || !in_array($_SESSION['rol'], [1, 2])) ? 'readonly' : ''; ?> required>

    <label for="psw"><b>Apellido del colaborador</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: Ramirez Requena" value="<?php echo $d->apepa; ?>" name="apep" <?php echo (!isset($_SESSION['rol']) || !in_array($_SESSION['rol'], [1, 2])) ? 'readonly' : ''; ?> required>

    <label for="psw"><b>Género del colaborador</b></label><span class="badge-warning">*</span>
    <select  name="gep" id="gep" required <?php echo (!isset($_SESSION['rol']) || !in_array($_SESSION['rol'], [1, 2])) ? 'readonly' : ''; ?>>
        <option value="<?php echo $d->sex; ?>" selected>Seleccione una opcion</option>
    ...
    <label for="psw"><b>Fecha de registro del colaborador</b></label><span class="badge-warning">*</span>
    <input type="text" disabled value="<?php echo $d->fere; ?>" name="fere" <?php echo (!isset($_SESSION['rol']) || !in_array($_SESSION['rol'], [1, 2])) ? 'readonly' : ''; ?> required>
