...
<head>
    ...
    <title>   SIE QDL | Documentos de los colaboradores</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Documentos de los colaboradores</a></li>
            </ul>
    ...
    $data[] = $r;
     ...
     <?php if(count($data)>0):?>
         <table id="example" class="responsive-table">
            <thead>
                <tr>
                    <th scope="col"># de Colaborador</th>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Teléfono"><?php echo $d->fere ?></td>
