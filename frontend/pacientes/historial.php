...
<head>
    ...
    <title>   SIE QDL | Historial de los colaboradores</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Historial de los colaboradores</a></li>
            </ul>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Área"><?php echo $d->grup ?></td>
                        <td data-title="Fecha de Ingreso"><?php echo $d->fere ?></td>
