...
<head>
    ...
    <title>   SIE QDL | Listado de Colaboradores</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los Colaboradores</a></li>
            </ul>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Empresa"><?php echo $d->nombre_empresa ?></td>
