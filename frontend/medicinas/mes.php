...
<head>
    ...
    <title>   SIE QDL | Registro Mensual de Medicamentos</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Registro Mensual de Medicamentos</a></li>
            </ul>
            <!--<button class="button" onclick="location.href='new_sale.php'">Nueva entrega</button>-->
          <div class="data">
                <div class="content-data">
                    <div class="head">
                        <h3>Registro Mensual de Medicamentos</h3>
...
$sentencia = $connect->prepare("SELECT * FROM monthly_deliveries;");
$sentencia->execute();
$data =  array();
if($sentencia){
         ...
         <table id="example" class="responsive-table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Medicamento o Insumo</th>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        <td data-title="Periodo"><?php echo $d->month_year ?></td>
                        <!--<td data-title="Fecha"><?php //echo $d->placed_on ?></td>
                        -->
                       
                        <td data-title="Código"><?php echo $d->product_code ?></td>
                        <td data-title="Medicamento o Insumo"><?php echo $d->product_name ?></td>
                        <td data-title="Cantidad"> <?php echo $d->delivered_quantity ?></td>
                    <td data-title="Costo"><?php echo $d->total_cost ?></td>
