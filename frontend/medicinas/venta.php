...
<head>
    ...
    <title>   SIE QDL | Entrega de medicinas</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Entrega de medicinas</a></li>
            </ul>
            <button class="button" onclick="location.href='new_sale.php'">Nueva entrega</button>
          <div class="data">
                <div class="content-data">
                    <div class="head">
                        <h3>Entrega de medicinas</h3>
...
$sentencia = $connect->prepare("SELECT orders.idord, orders.id_consulta, orders.total_price, orders.placed_on, patients.idpa, patients.numhs,patients.nompa, patients.apepa, users.id, users.name, orders.total_products, orders.placed_on, events.monto, events.fere FROM orders INNER JOIN patients ON orders.idpa = patients.idpa INNER JOIN users ON orders.user_id = users.id INNER JOIN events ON orders.id_consulta = events.id ORDER BY idord DESC;");
$sentencia->execute();
$data =  array();
if($sentencia){
         ...
         <table id="example" class="responsive-table">
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        <td data-title="ID"><?php echo $d->fere ?></td>
                    ...
                    <td data-title="Costo"><?php echo $d->total_price ?></td>
                    
                        
                        <td>
                        <a title="Información" href="../citas/info.php?id=<?php echo $d->id_consulta ?>" class="fa fa-info"></a>
                            <?php 
                if ($d->tipc ='Boleta') {
