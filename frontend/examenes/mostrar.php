...
<head>
    ...
    <title>   SIE QDL | Listado de los Examenes Internos</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los Examenes Internos</a></li>
            </ul>
            <button class="button" onclick="location.href='nuevo.php'">Nuevo</button>
          <div class="data">
                <div class="content-data">
                    <div class="head">
                        <h3>Examenes Internos</h3>
...
$sentencia = $connect->prepare("SELECT examenes.idex, examenes.status, examenes.observaciones, examenes.fecha, examenes.nombre FROM examenes ORDER BY idex DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
         ...
         <table id="example" class="responsive-table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Apto o No Apto</th>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Médico"><?php echo $d->nombre ?></td>
                        <td data-title="Médico"><?php echo $d->status ?></td>
                        <td data-title="Médico"><?php echo $d->observaciones ?></td>
                        <td>

                            

                <a title="Información" href="../examenes/info.php?id=<?php echo $d->idex ?>" class="fa fa-info"></a>
               
                
                <?php 
                                
                                
                echo '<a title="Boleta"  href="../examenes/documento.php?id='.$d->idex.'" class="fa fa-file-text-o"></a>';
                echo '<a title="Actualizar" href="../examenes/editar.php?id=' .$d->idex. '" class="fa fa-pencil tooltip"></a>';
                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){
                //echo '<a title="Ticket"  href="../examenes/ticket.php?id='.$d->idex.'" class="fa fa-ticket"></a>';                  
                }    
...
<?php if (in_array($_SESSION['rol'], [1, 2])): ?>
                ...
                <button name='delete_examen' style="cursor: pointer;" class="fa fa-trash"></button>
                </form>
                        <?php endif; ?>
                        </td>
                    </tr>
    ...
    <?php include_once '../../backend/php/delete_examen.php' ?>
