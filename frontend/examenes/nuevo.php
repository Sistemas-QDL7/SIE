...
<head>
    ...
    <title>   SIE QDL | Nuevo Examen Interno</title>
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../examenes/mostrar.php">Listado de los Examenes Internos</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Registrar Examen</a></li>
            </ul>

            <!-- multistep form -->
            <form action="../../backend/php/add_exam.php" enctype="multipart/form-data" method="POST" autocomplete="off">
                <div class="containerss">
                    ...
                    <input type="date" name="fecha" required readonly value="<?php echo date('Y-m-d'); ?>">

                    <label for="psw"><b>Nombre</b></label><span class="badge-warning">*</span>
                    <input type="text" name="nombre" placeholder="Nombre del colaborador..." autocomplete="off">

                    
                    <label for="email"><b>Apto o No Apto</b></label><span class="badge-warning">*</span>
                    ...
                    <textarea name="observaciones" maxlength="255" placeholder="Observaciones..."></textarea>
                    ...
                    <hr>
                    <button type="submit" name="add_exam" class="registerbtn">Guardar</button>
                </div>
            </form>
        </main>
        <!-- MAIN -->
    ...
    <?php include_once '../../backend/php/add_exam.php' ?>
</body>
</html>