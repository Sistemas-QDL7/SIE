...
<head>
    ...
    <title>   SIE QDL | Listado del personal</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado del personal</a></li>
            </ul>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Área"><?php echo $d->nomesp ?></td>
                        ...
                        <?php 
                                if ($_SESSION['rol'] == 1) {
                                    // code...
                                    echo '<a title="Actualizar" href="../medicos/editar.php?id=<?php echo $d->idodc ?>" class="fa fa-pencil tooltip"></a>';
