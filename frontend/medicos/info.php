    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../medicos/mostrar.php">Listado del personal</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Información del personal</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
   ...
   <br>
    ...
    <label for="email"><b># Colaboradores</b></label><span class="badge-warning">*</span>
    ...
    <label for="psw"><b>Género</b></label><span class="badge-warning">*</span>
    ...
    if(!isset($_SESSION['rol']) || $_SESSION['rol'] == 1){?>
        ...
        <label for="psw"><b>Dirección</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="ejm: calle los medanos" value="<?php echo $d->direcd; ?>" name="dime" readonly required><?php
  }
  ?>
