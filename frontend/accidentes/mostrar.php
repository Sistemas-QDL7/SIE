...
<head>
    ...
    <title>   SIE QDL | Listado de los accidentes</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los accidentes</a></li>
            </ul>
...
$sentencia = $connect->prepare("SELECT accidentes.id_acc,
                                                accidentes.idlab, 
                                                accidentes.fecha, 
                                                accidentes.lesion, 
                                                accidentes.incapacidad, 
                                                accidentes.mecanismo_accidente, 
                                                laboratory.idlab, 
                                                laboratory.nomlab, 
                                                patients.idpa, 
                                                patients.numhs, 
         ...
         <table id="example" class="responsive-table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Mecanismo del Accidente</th>
                    <th scope="col">Servicio de Atencion</th>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Cita"><?php echo $d->numhs ?></td>
                        <td data-title="Médico"><?php echo $d->nompa ?>&nbsp;<?php echo $d->apepa ?></td>
                        <td data-title="Médico"><?php echo $d->grup ?></td>
                        <td data-title="Médico"><?php echo $d->lesion ?></td>
                        <td data-title="Laboratorio"><?php echo $d->incapacidad ?></td>
                        <td data-title="Fecha inicio"><?php echo $d->mecanismo_accidente ?></td>
                        <td data-title="Servicio de Atencion"><?php echo $d->nomlab ?></td>
                        <td>

                            

                <a title="Información" href="../accidentes/info.php?id=<?php echo $d->id_acc ?>" class="fa fa-info"></a>
               
                
                <?php 
                                
                                
                echo '<a title="Boleta"  href="../accidentes/documento.php?id='.$d->id_acc.'" class="fa fa-file-text-o"></a>';
                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){
                //echo '<a title="Ticket"  href="../accidentes/ticket.php?id='.$d->id_acc.'" class="fa fa-ticket"></a>';
                }                  
...
<?php if (in_array($_SESSION['rol'], [1, 2])): ?>
                ...
                <input type='hidden' name='id_acc' value="<?php echo  $d->id_acc; ?>">
                <button name='delete_accidente' style="cursor: pointer;" class="fa fa-trash"></button>
                </form>
                        <?php endif; ?>
                        </td>
                    </tr>
    ...
    <?php include_once '../../backend/php/delete_accidente.php' ?>
