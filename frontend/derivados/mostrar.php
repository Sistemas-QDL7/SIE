...
<head>
    ...
    <title>   SIE QDL | Listado de los Colaboradores Derivados</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los Colaboradores Derivados</a></li>
            </ul>
            <button class="button" onclick="location.href='nuevo.php'">Nuevo</button>
          <div class="data">
                <div class="content-data">
                    <div class="head">
                        <h3>Colaboradores Derivados</h3>

                    </div>
                   <div class="table-responsive" style="overflow-x:auto;">
                       <?php 
require '../../backend/bd/Conexion.php';
$sentencia = $connect->prepare("SELECT derivados.id_der, derivados.idpa, derivados.causa, derivados.obs, derivados.fecha,  patients.idpa, patients.numhs, patients.nompa, patients.apepa, patients.grup FROM derivados INNER JOIN patients ON derivados.idpa = patients.idpa ORDER BY id_der DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="Médico"><?php echo $d->causa ?></td>
                        <td data-title="Médico"><?php echo $d->obs ?></td>
                        <td>

                            

                <a title="Información" href="../derivados/info.php?id=<?php echo $d->id_der ?>" class="fa fa-info"></a>
               
                
                <?php 
                                
                                
                echo '<a title="Boleta"  href="../derivados/documento.php?id='.$d->id_der.'" class="fa fa-file-text-o"></a>';
                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){
                //echo '<a title="Ticket"  href="../derivados/ticket.php?id='.$d->id_der.'" class="fa fa-ticket"></a>';                  
                }                
...
<?php if (in_array($_SESSION['rol'], [1, 2])): ?>
                ...
                <input type='hidden' name='id_der' value="<?php echo  $d->id_der; ?>">
                <button name='delete_derivados' style="cursor: pointer;" class="fa fa-trash"></button>
                </form>
                        <?php endif; ?>
                        </td>
                    </tr>
    ...
    <?php include_once '../../backend/php/delete_derivados.php' ?>
    <!-- NAVBAR -->
