...
<head>
    ...
    <title>   SIE QDL | Nuevo Colaborador Derivado</title>
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../derivados/mostrar.php">Listado de los Colaboradores Derivadosl</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Registrar Colaborador Derivado</a></li>
            </ul>

            <!-- multistep form -->
            <form action="../../backend/php/add_derivados.php" enctype="multipart/form-data" method="POST" autocomplete="off">
                <div class="containerss">
                    <h1>Registrar Colaborador Derivado</h1>
                    ...
                    <hr>
                    <br>
                    <label for="fecha"><b>Fecha</b></label><span class="badge-warning">*</span>
                    <input type="text" id="fecha" name="fecha" readonly placeholder="">

                    <script>
                        // Obtener la fecha actual
                        const hoy = new Date();
                        const dia = String(hoy.getDate()).padStart(2, '0');
                        const mes = String(hoy.getMonth() + 1).padStart(2, '0'); // Meses 0-11
                        ...
                        fechaInput.value = fechaActual; // ¡Asegúrate de que el valor se envíe al servidor!
                    </script>
                    ...
                    <textarea name="causa" style="height:200px" maxlength="255" placeholder="Causa..."></textarea>

                    <label for="email"><b>Observaciones</b></label><span class="badge-warning">*</span>
                    <textarea name="obs" style="height:200px" maxlength="255" placeholder="Observaciones..."></textarea>

                    
                    <hr>
                    <button type="submit" name="add_derivados" class="registerbtn">Guardar</button>
                </div>
            </form>
        </main>
        <!-- MAIN -->
    ...
    <?php include_once '../../backend/php/add_derivados.php' ?>
</body>
</html>