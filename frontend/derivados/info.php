...
<head>
    ...
    <title>   SIE QDL | Información de los Colaboradores Derivados</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <h1 class="title">Bienvenido <?php echo '<strong>'.$_SESSION['name'].'</strong>'; ?></h1>
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../derivados/mostrar.php">Listado de los Colaboradores Derivados</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Información de los Colaboradores Derivados</a></li>
            </ul>
                   <!-- multistep form -->
<?php 
require '../../backend/bd/Conexion.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT derivados.id_der, derivados.fecha, derivados.causa, derivados.obs, derivados.idpa, patients.idpa, patients.numhs, patients.nompa, patients.apepa, patients.grup FROM derivados INNER JOIN patients ON derivados.idpa = patients.idpa WHERE id_der= '$id';");
 $sentencia->execute();
...
<br>
    ...
    <input readonly type="text" value="<?php echo $d->fecha; ?>" name="appini"required="">
    ...
    <label for="email"><b>Causa</b></label><span class="badge-warning">*</span>
    <textarea name="appnam" style="height:200px" readonly placeholder="Write something.."><?php echo $d->causa; ?> </textarea>

    <label for="psw"><b>Observaciones</b></label><span class="badge-warning">*</span>
    <textarea name="appnam" style="height:200px" readonly placeholder="Write something.."><?php echo $d->obs; ?> </textarea>
