...
<head>
    ...
    <title>   SIE QDL | Listado de las Incapacidades</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de las incapacidades</a></li>
            </ul>
...
$sentencia = $connect->prepare("SELECT incapacidades.idinc, incapacidades.folio, incapacidades.idpa, incapacidades.inicio, incapacidades.fin, incapacidades.dias, incapacidades.motivo, incapacidades.ini_sub, incapacidades.dias_acum, incapacidades.tipo, patients.idpa, patients.numhs, patients.nompa, patients.apepa, patients.grup FROM incapacidades INNER JOIN patients ON incapacidades.idpa = patients.idpa ORDER BY idinc DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
         ...
         <table id="example" class="responsive-table">
            <thead>
                <tr>
                    ...
                    <th scope="col">Inicio de incapacidad</th>
                    <th scope="col">Fin de incapacidad</th>
                    <th scope="col">Días de incapacidad</th>
                   <!-- <th scope="col">Motivo</th>
                    <th scope="col">Inicial/Subsecuente</th>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        <th scope="row"><?php echo $d ->folio;?></th>
                        <td data-title="Médico"><?php  echo $d ->numhs;?></td>
                        <td data-title="Médico"><?php echo $d->nompa .  ' ' . $d->apepa;?></td>
                        <td data-title="Médico"><?php echo $d->grup ?></td>
                        <td data-title="Médico"><?php echo $d->inicio ?></td>
                        <td data-title="Médico"><?php echo $d->fin ?></td>
                        <td data-title="Médico"><?php echo $d->dias?></td>
                       <!-- <td data-title="Médico"><?php echo $d->motivo?></td>
                        <td data-title="Médico"><?php echo $d->ini_sub?></td>
                        <td data-title="Médico"><?php echo $d->dias_acum?></td>
                        <td data-title="Médico"><?php echo $d->tipo?></td>-->
                        <td>

                            

                <a title="Información" href="../incapacidades/info.php?id=<?php echo $d->idinc ?>" class="fa fa-info"></a>
               
                
                <?php 
                                
                                
                echo '<a title="Boleta"  href="../incapacidades/documento.php?id='.$d->idinc.'" class="fa fa-file-text-o"></a>';
                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2){
                //echo '<a title="Ticket"  href="../incapacidades/ticket.php?id='.$d->idinc.'" class="fa fa-ticket"></a>';                  
                }            
...
<?php if (in_array($_SESSION['rol'], [1, 2])): ?>
                ...
                <input type='hidden' name='idinc' value="<?php echo  $d->idinc; ?>">
                <button name='delete_incapacidad' style="cursor: pointer;" class="fa fa-trash"></button>
                </form>
                        <?php endif; ?>
                        </td>
                    </tr>
    ...
    <?php include_once '../../backend/php/delete_incapacidad.php' ?>
    <!-- NAVBAR -->
