...
<head>
    ...
    <title>   SIE QDL | Información de la Incapacidad</title>
</head>
<body>
...
<br>
    ...
    <input readonly type="date" value="<?php echo $d->inicio; ?>" name="appini"required="">

    <label for="email"><b>Fecha Final</b></label><span class="badge-warning">*</span>
    <input readonly type="date" value="<?php echo $d->fin; ?>" name="appini"required="">

    <label for="psw"><b># Colaboradores</b></label><span class="badge-warning">*</span>
    <select required name="" id="lab" readonly>
        <option><?php echo $d->numhs; ?></option>
    </select>
    ...
    <textarea name="appnam" style="height:200px" readonly placeholder="Write something.."><?php echo $d->motivo; ?> </textarea>
  
    <label for="psw"><b>Folio</b></label><span class="badge-warning">*</span>
    <input readonly type="text" value="<?php echo $d->folio; ?>" name="appini"required="">

    <label for="psw"><b>Días de incapacidad</b></label><span class="badge-warning">*</span>
    <select readonly required name="" id="doc">
        <option><?php echo $d->dias; ?></option>
    </select>

    <label for="psw"><b>Inicial o Subcecuente</b></label><span class="badge-warning">*</span>
    <input readonly type="text" value="<?php echo $d->ini_sub; ?>" name="appini"required="">

    <label for="psw"><b>Dias Acumulados</b></label><span class="badge-warning">*</span>
    <input readonly type="text" value="<?php echo $d->dias_acum; ?>" name="appini"required="">

    <label for="psw"><b>Tipo</b></label><span class="badge-warning">*</span>
    <input readonly type="text" value="<?php echo $d->tipo; ?>" name="appini"required="">
